...
const adminNavigation = [
	{ url: "/admin", text: "Inicio", blank: false },
...
export default function AdminSidebar() {
	...
	return (
		<>
			<div className="flex justify-center max-h-70">
				<Logo />
			</div>
			<div className="space-y-3 ">
				<p className="sm:mt-0 lg:mt-0 xl:mt-20 uppercase font-bold text-sm text-white text-center">
