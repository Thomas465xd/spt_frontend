...
import { IdentificationsEnum, UserLoginForm } from "@/types/index";
	...
	return (
		<form className="form" onSubmit={handleSubmit(handleLogin)} noValidate>
			<div className="grid grid-cols-1 md:grid-cols-3 gap-5">
				<div className="">
					<label className="label text-2xl font-normal">
						Tipo de ID
					</label>
					<select
						className="input"
			...
			<div className="flex flex-col gap-5">
				<div className="">
					<label className="label text-2xl font-normal">Email</label>
					<input
						type="email"
			...
			<div className="flex-flex-col-gap-5 border-b border-gray-400 pb-8">
				<label className="label text-2xl font-normal">Contraseña</label>
				<input
					type="password"
			...
			<p className="text-sm text-gray-400">
				<span className="text-red-500">*</span> Para iniciar sesión su
				cuenta debe estar confirmada y tener la contraseña configurada.
			</p>
