			...
			<Dialog as="div" className="relative z-50" onClose={handleClose}>
				...
				<div className="fixed inset-0 flex items-center justify-center p-4">
					...
					>
						...
						<Dialog.Panel
							className="w-full max-w-4xl md:max-w-2xl bg-white rounded-2xl shadow-lg overflow-hidden transform transition-all 
								...
								<div className="p-4 w-full md:w-1/2 flex flex-col justify-between">
									<div className="space-y-3">
										...
										<div className="">
											...
											>
												<strong>SKU:</strong>{" "}
												<span className="hover:underline hover:text-orange-600 transition-colors duratoin-100">
													{product.variant?.code}
												</span>
											</p>
										</div>
										...
										<p className="text-center font-semibold text-slate-600 border-t border-gray-300 pt-2">
											Disponibilidad:
										</p>
