    ...
    return (
        <>
            ...
            <p className="text-center p-5 text-gray-700">
                Descubre herramientas, recursos y <span className="text-orange-500 font-semibold">beneficios exclusivos</span> diseñados para potenciar tu experiencia.
            </p>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <div className="bg-white/10 backdrop-blur-sm p-5 rounded-lg border border-white/20 transform transition-transform hover:scale-105">
                                    ...
                                    <p className="text-gray-300 text-sm">
                                        Accede a precios especiales y promociones diseñadas específicamente para ti.
                                    </p>

                                    <Link to="/discounts" className="inline-block mt-4 text-orange-400 hover:text-orange-300 text-sm font-medium">
                                        Ver descuentos →
                                    </Link>
                                </div>
