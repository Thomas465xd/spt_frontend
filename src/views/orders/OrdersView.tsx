...
import { CheckCircle, Earth, Package, Truck, XCircle } from "lucide-react";
			...
			<>
				...
				{!hasActiveSearch && (
					<p className="text-gray-700 text-center my-10">
						Aquí puedes ver el Estado de las ordenes realizadas por
						tu Empresa
					</p>
				)}
				...
				{hasActiveSearch ? (
					...
					<p className="text-gray-700 text-center my-10 border-b border-gray-300 pb-5">
						No hay órdenes registradas. Realiza una búsqueda o
						espera a que se registren nuevas órdenes.
					</p>
				)}
	...
	return (
		<>
			...
			<p className="text-gray-700 text-center mt-10">
				Aquí puedes ver el Estado de las ordenes realizadas por tu
				Empresa.
			</p>
			...
			<p className="text-gray-700 text-center mt-10">
				Cuando el Estado de la orden cambie,{" "}
				<span className="font-bold text-orange-500">
					serás notificado por correo
				</span>
			</p>
			...
			<div className="max-w-7xl xl:max-w-full mx-auto rounded-md">
				<OrderTable orders={orders} admin={false} />
			</div>
