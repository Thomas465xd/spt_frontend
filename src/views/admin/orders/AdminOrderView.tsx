...
import { CheckCircle, Earth, Package, Pen, Truck, XCircle } from "lucide-react";
...
export default function AdminOrdersView() {
			...
			<>
				...
				{!hasActiveSearch && (
					<p className="text-gray-700 text-center my-10">
						Aquí puedes ver los Detalles de las Órdenes y{" "}
				...
				{hasActiveSearch ? (
					...
					<p className="text-gray-700 text-center my-10 border-b border-gray-300 pb-5">
						...
						comienza a registrar nuevas ordenes.
					</p>
				)}
	...
	return (
		<>
			...
			<p className="text-gray-700 text-center my-10">
				Al cambiar el estado de la orden, el cliente{" "}
				<span className="font-bold text-orange-500">
			...
			<div className="my-[32px] max-w-7xl xl:max-w-full mx-auto">
				<OrderTable admin={true} orders={orders} />
			</div>
