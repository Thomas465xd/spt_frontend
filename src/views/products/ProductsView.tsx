...
export default function ProductsView() {
	...
	if (isErrorProducts)
		return (
			<>
				<Heading>Error al Cargar Productos</Heading>

				<p className="text-center text-gray-500 my-10">
					Si crees que esto se trata de un error, contacta al
	...
	if (totalPages === 0 || page === 0)
		return (
			<>
				...
				<p className="text-center text-gray-500 my-10">
					No hay Resultados de Busqueda para:{" "}
	...
	if (page > totalPages)
		return <Navigate to={`/products?page=${totalPages}`} replace />;
	...
	return (
		<>
			...
			<p className="text-center mt-5 text-gray-500">
				...
				para encontrar el producto que necesitas
			</p>
			...
			{cartModal === "true" && <CartDetailsModal />}
		</>
	);
}
